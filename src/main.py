...
from Retrieval.sparseDense_retrieval import SparseDenseRetrieval
...
def main():
    ...
    if config.dataRetrieval.eval(True) and training_args.do_predict:
        ...
        if config.dataRetrieval.type() == "sparse":
        ...
        elif config.dataRetrieval.type() == "sparseDense":
            ...
            retriever = SparseDenseRetrieval(
                ...
                ratio=config.dataRetrieval.sparse_ratio(),
                context_path=config.dataRetrieval.context_path(),
            )
